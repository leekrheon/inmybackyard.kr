    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          /* ── Glass nav: 하단 고정 ── */
          /* 모바일 nav: PNG 워드마크는 4개를 합치면 원래도 너비가 넓어서(비율 합 15:1 이상),
             화면에 맞춰 키우려 할수록 좌우로 넘쳐(overflow) 잘려 보이던 게 진짜 원인이었음.
             → 모바일에서는 이미지를 끄고 실제 텍스트(::after)로 대체: 폰트는 굵고 압축적이라
             같은 공간에서 훨씬 크고 뚜렷하게 보이고, 화면 폭도 넘치지 않음. */
          .glass-nav {
            top: auto !important;
