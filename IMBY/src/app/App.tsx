...
function PressPage({ isAdmin }: { isAdmin: boolean }) {
  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-screen bg-white text-black" style={{ fontFamily: "Pretendard, -apple-system, BlinkMacSystemFont, sans-serif" }} style={{ scrollbarWidth: 'none' }}>
        <style>{`
