    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .glass-nav button { padding: 0.6rem 1.1rem !important; }
          .nav-label { height: 28px !important; width: auto !important; object-fit: contain !important; }

          /* ── Projects: 필터 한 줄 최상단 (open일 때만) ── */
          #sub-menu {
            top: 0 !important;
          ...
          #ment3-wrap {
            top: 8vh !important; right: 0 !important;
