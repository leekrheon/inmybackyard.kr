            ...
            {loading ? (
              ...
              <>
                <div className="w-full aspect-video bg-gray-100 overflow-hidden relative cursor-pointer"
                  onClick={() => sliderItems[sliderIndex].source_url ? window.open(sliderItems[sliderIndex].source_url, '_blank') : null}>
                ...
                <div className="flex justify-between items-start text-sm mt-2">
                  ...
                  <div className="text-right max-w-[60%]">
                    ...
                    <button onClick={() => setSelected(sliderItems[sliderIndex])}
                      ...
                      onClick={() => sliderItems[sliderIndex].source_url && window.open(sliderItems[sliderIndex].source_url, '_blank')}>
            ...
            <div className="flex flex-col">
              {items.map(item => (
                <div key={item.id}
                  ...
                  onClick={() => item.source_url ? window.open(item.source_url, '_blank') : setSelected(item)}
                >
