    ...
    >
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-40 flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-black/90 hover:bg-black text-white px-5 py-3 rounded-full font-medium shadow-xl transition-all duration-300 hover:scale-105 active:scale-95"
        ...
        {isAdmin && (
          <button
            ...
            className="flex items-center gap-2 bg-[#0FCD60] hover:bg-green-500 text-white px-5 py-3 rounded-full font-medium shadow-xl transition-all hover:scale-105 active:scale-95"
