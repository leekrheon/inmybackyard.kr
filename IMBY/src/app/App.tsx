    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .glass-nav button { padding: 0.5rem 0.85rem !important; }
          .nav-label { height: 22px !important; }
          ...
          /* ── Intro slide2: info2 정중앙, ment2 세로 중앙 ── */
          .mobile-slide2-info {
          ...
          /* ── Intro slide3: info3 정중앙, ment3 세로 중앙 + 1.6배 ── */
