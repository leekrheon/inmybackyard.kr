  ...
  return (
    <>
      ...
      <div ref={glassNavRef} id="glass-nav" className="glass-nav no-select">
        ...
        {isAdmin ? (
          <span className="flex items-center px-3 gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#0FCD60] animate-pulse" />
            <span className="text-[10px] font-bold text-[#0FCD60] tracking-widest font-[CinemaSansTTF]">ADMIN</span>
          </span>
        ) : (
          <button
            className="font-[CinemaSansTTF] text-gray-400 hover:text-black"
