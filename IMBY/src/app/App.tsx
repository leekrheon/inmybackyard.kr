  ...
  useEffect(() => {
    ...
    function renderIntroSequence() {
      ...
      if (introImgContainerRef.current) {
        ...
        introImgContainerRef.current.style.height = `${curH}vh`;
  ...
  return (
    <>
      <style>{`
        ...
        .filter-label { height: 14px; width: auto; object-fit: contain; display: block; filter: brightness(0); transition: filter 0.2s ease; }
        ...
        .nav-label { height: 13px; width: auto; object-fit: contain; display: block; filter: brightness(0); transition: filter 0.35s cubic-bezier(0.16, 1, 0.3, 1); }
        ...
        #intro-img-container { width: 0vw; height: 0vh; will-change: width, height; overflow: hidden; }
        @media (max-width: 768px) { #intro-img-container { width: 0vw; height: 0vh; } .site-logo { top: 1.2rem; left: 1.2rem; } }
