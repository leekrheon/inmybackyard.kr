  ...
  useEffect(() => {
    ...
    function renderIntroSequence() {
      ...
      if (progressBar) {
        ...
        progressBar.style.backgroundColor = s.currentIntroProgress > 13 ? '#ffffff' : '#22CD6D';
      }
    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          /* Glass nav — 모바일에서 작게 */
          .glass-nav { top: 1rem; gap: 0.1rem; padding: 0.25rem; }
          .glass-nav button { font-size: 0.78rem; padding: 0.35rem 0.7rem; }
          .nav-label { height: 13px; }
          .nav-instagram { height: 13px; }

          /* Admin 버튼 */
          .site-logo { top: 2.5rem; left: 1rem; }
          #admin-btn-wrapper { top: 2.5rem; right: 1rem; }

          /* 서브메뉴 */
          #sub-menu { top: 5rem; left: 1.2rem; font-size: 0.9rem; }
          .filter-label { height: 20px; }

          /* Gallery */
          #gallery-track { gap: 10vw; padding: 0 20vw; }
          .gallery-img { height: 45vh; max-width: 75vw; }
        ...
        <div ref={step2ContainerRef} className="intro-layer" style={{ pointerEvents: 'none' }}>
          ...
          <img id="slide1-info" src="/info1.png" alt="info1"
            style={{ position: 'absolute', bottom: 0, left: '50%', transform: 'translateX(-50%)',
              height: 'clamp(200px, 50vh, 780px)', width: 'auto',
              maxWidth: '95vw',
              objectFit: 'contain',
          ...
          <div id="slide2-ment" style={{ position: 'absolute', top: 0, left: 0, width: '50%', height: '100%',
            ...
            <img ref={typo2Ref} src="/ment2.svg" alt="ment2"
              style={{ width: '101%', objectFit: 'contain', objectPosition: 'left center', filter: 'brightness(0)' }} />
          </div>
        </div>
        ...
        <div ref={step4ContainerRef} className="intro-layer" style={{ pointerEvents: 'none' }}>
          ...
          <img id="info3-1-img" src="/info3-1.png" alt="info3-1"
            style={{ position: 'absolute', bottom: 0, left: '3%',
              height: 'clamp(200px, 55vh, 900px)', width: 'auto',
              maxWidth: '55vw',
              objectFit: 'contain',
              opacity: 0, pointerEvents: 'none' }} />
          ...
          <div id="ment3-wrap" style={{ position: 'absolute', top: 0, right: 0, width: '50%', height: '100%',
            ...
            <img ref={typo3Ref} src="/ment3.svg" alt="ment3"
              style={{ width: '100%', objectFit: 'contain', objectPosition: 'left center', filter: 'brightness(0)' }} />
          </div>
        </div>
